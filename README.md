...
| production_readiness_guide.md | **Production Readiness** | v1.3 | [Telemetry validation, dashboard checks, access review, alerting guidance & rollout sign-off](./docs/production_readiness_guide.md). |
